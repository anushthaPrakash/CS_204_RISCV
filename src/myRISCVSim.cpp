    ...
    // {
        ...
        switch (Type)
        {
            case 'R':
            {
                ...
                if ((operand1 == DE_EX.rd2 || operand2 == DE_EX.rd2) && cycle_no > 2 && DE_EX.rd2 != 0)  {stall = 4;Tall = 4;}
                break;
            }
            case 'I':
            {
                ...
                if (operand1 == DE_EX.rd2 && cycle_no > 2 && DE_EX.rd2 != 0)       {stall = 4;Tall = 4; Stalls_D+=3; Data_H++;DE_EX.Stall = stall-1;}
                break;
            }
            case 'S':
            {
                ...
                if ((operand1 == DE_EX.rd2 || operand2 == DE_EX.rd2) && DE_EX.rd2 != 0)      { stall = 4; Tall = 4; Stalls_D+=3; Data_H++; DE_EX.Stall = stall-1;}
                break;
            }
            case 'B':
            {
        ...
        if(stall == 4){
            ...
            if (subtype == "beq"){
                if (X[operand1] == X[operand2]){
                    ...
                    Stalls_C+=2; Con_H++;des_res = 0;des_reg = 0; 
                    //control hazard
                }
                else{
                    if (flag == 1)
